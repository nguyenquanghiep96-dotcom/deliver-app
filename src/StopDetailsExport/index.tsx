import svgPaths from "./svg-uh1w3x0b6s";
...
import imgBuildingImage4 from "./728df57c94c204c5fd600431050e922ec8638b53.png";
  ...
  return (
    <div className="content-stretch flex gap-[6px] items-center relative shrink-0 w-[89px]" data-name="Stop Info Container">
      <div className="[text-box-edge:cap_alphabetic] [text-box-trim:trim-both] [word-break:break-word] flex flex-col font-['Proxima_Nova:Bold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[#ff7048] text-[14px] whitespace-nowrap">
        <p className="leading-[normal]">#2-24756</p>
      </div>
...
function NoteContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[6px] items-start relative rounded-[5px] shrink-0 w-full" data-name="Note Container">
      <NoteHeader />
      <p className="[word-break:break-word] font-['Google_Sans_Flex:Regular',sans-serif] font-normal leading-[normal] min-w-full not-italic relative shrink-0 text-[#71727a] text-[14px] w-[min-content]" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
...
function ButtonFilled() {
  return (
    <div className="bg-[#ff7048] flex-[1_0_0] min-w-px relative rounded-[16px]" data-name="Button/Filled">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-center px-[30px] py-[15.5px] relative size-full">
          <Navigation24DpE3E3E3Fill1Wght400Grad0Opsz />
          <div className="[word-break:break-word] flex flex-col font-['Google_Sans_Flex:SemiBold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
            <p className="leading-[normal]">Navigate</p>
          </div>
        </div>
      </div>
...
function ButtonFilled1() {
  return (
    <div className="bg-[#ff7048] relative rounded-[16px] self-stretch shrink-0" data-name="Button/Filled">
      <div className="flex flex-row items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[6px] items-center justify-center px-[30px] py-[15.5px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Google_Sans_Flex:SemiBold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
            <p className="leading-[normal]">Mark Stop Done</p>
          </div>
        </div>
      </div>
      <div aria-hidden className="absolute border border-[#faa087] border-solid inset-0 pointer-events-none rounded-[16px]" />
...
function ActionButtonsContainer() {
  return (
    <div className="content-stretch flex gap-[10px] items-start relative shrink-0 w-[356px]" data-name="Action Buttons Container">
      <ButtonFilled />
      <ButtonFilled1 />
    </div>
  );
...
function AddPhotoContainer() {
  return (
    <div className="content-stretch flex gap-[16px] items-center py-[16px] relative shrink-0 w-full" data-name="Add Photo Container">
...
function PaymentContainer() {
  return (
    <div className="content-stretch flex gap-[16px] items-center py-[16px] relative shrink-0 w-full" data-name="Payment Container">
      <div aria-hidden className="absolute border-[#e8e9f1] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
        <PaymentHeader />
      </div>
...
function SignatureContainer() {
  return (
    <div className="content-stretch flex gap-[16px] items-center py-[16px] relative shrink-0 w-full" data-name="Signature Container">
      <div aria-hidden className="absolute border-[#e8e9f1] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
        <SignatureHeader />
      </div>
...
function CommentContainer() {
  return (
    <div className="content-stretch flex gap-[16px] items-center py-[16px] relative shrink-0 w-full" data-name="Comment Container">
      <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
        <CommentHeader />
      </div>
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Arrow Icon">
...
function AddressInfo() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[10px] items-start left-[16px] top-[122px] w-[361px]" data-name="Address Info">
      <AddressAndStatus />
      <RecentStopCard />
    </div>
  );
...
function BuildingDetailsHeaderContainer() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Building Details Header Container">
      <BuildingDetailsList />
    </div>
  );
}
...
function BuildingImage() {
  return (
    <div className="relative rounded-[16px] shrink-0 size-[209px]" data-name="Building Image 1">
      <div aria-hidden className="absolute inset-0 rounded-[16px]">
        <div className="absolute bg-white inset-0 rounded-[16px]" />
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgBuildingImage1} />
      </div>
...
function BuildingImage1() {
  return (
    <div className="relative rounded-[16px] shrink-0 size-[209px]" data-name="Building Image 2">
      <div aria-hidden className="absolute inset-0 rounded-[16px]">
        <div className="absolute bg-white inset-0 rounded-[16px]" />
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgBuildingImage2} />
      </div>
      <div aria-hidden className="absolute border border-[#d8dadf] border-solid inset-0 rounded-[16px]" />
    </div>
  );
...
function BuildingImage2() {
  return (
    <div className="relative rounded-[16px] shrink-0 size-[209px]" data-name="Building Image 3">
      <div aria-hidden className="absolute inset-0 rounded-[16px]">
        <div className="absolute bg-white inset-0 rounded-[16px]" />
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgBuildingImage3} />
      </div>
      <div aria-hidden className="absolute border border-[#d8dadf] border-solid inset-0 rounded-[16px]" />
    </div>
  );
...
function BuildingImage3() {
  return (
    <div className="relative rounded-[16px] shrink-0 size-[209px]" data-name="Building Image 4">
      <div aria-hidden className="absolute inset-0 rounded-[16px]">
        <div className="absolute bg-white inset-0 rounded-[16px]" />
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgBuildingImage4} />
      </div>
      <div aria-hidden className="absolute border border-[#d8dadf] border-solid inset-0 rounded-[16px]" />
    </div>
  );
...
function BuildingImage4() {
  return (
    <div className="relative rounded-[16px] shrink-0 size-[209px]" data-name="Building Image 5">
      <div aria-hidden className="absolute inset-0 rounded-[16px]">
        <div className="absolute bg-white inset-0 rounded-[16px]" />
        <img alt="" className="absolute max-w-none object-cover rounded-[16px] size-full" src={imgBuildingImage4} />
      </div>
...
function BuildingDetailsContainer() {
  return (
...
function BuildingStyleContainer1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start justify-center pb-[10px] relative shrink-0 w-full" data-name="Building Style Container">
      <div aria-hidden className="absolute border-[#d4d6dd] border-b border-solid inset-0 pointer-events-none" />
      <div className="[word-break:break-word] flex flex-col font-['Google_Sans_Flex:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#71727a] text-[14px] w-full" style={{ fontVariationSettings: '"GRAD" 0, "ROND" 0, "wdth" 100' }}>
...
function PhoneInfo() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start leading-[0] min-w-px not-italic relative" data-name="Phone Info">
...
function ButtonFilled2() {
  return (
    <div className="bg-[#ff7048] content-stretch flex gap-[6px] items-center justify-center overflow-clip px-[30px] py-[14.5px] relative rounded-[16px] shrink-0 w-[129px]" data-name="Button/Filled">
...
function SizeContainer1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center pb-[10px] relative shrink-0 w-[361px]" data-name="Size Container">
      <PhoneInfo />
      <ButtonFilled2 />
    </div>
  );
...
function BuildingDetailsList1() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Building Details List">
      <BuildingStyleContainer1 />
      <SizeContainer1 />
    </div>
  );
}

function BuildingDetailsHeaderContainer1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Building Details Header Container">
      <BuildingDetailsList1 />
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Building Info Container">
      <div className="content-stretch flex flex-col items-start pt-[16px] px-[16px] relative size-full">
        <BuildingDetailsHeaderContainer1 />
      </div>
    </div>
  );
}
...
function MainContainer() {
  return (
    <div className="-translate-x-1/2 absolute content-stretch flex flex-col gap-[25px] items-start left-1/2 top-[634px] w-[393px]" data-name="Main Container">
...
function ButtonFilled3() {
  return (
    <div className="absolute bg-[#ff7048] content-stretch flex gap-[6px] items-center justify-center left-[calc(40%+46.3px)] overflow-clip px-[30px] py-[14.5px] rounded-[16px] top-[696px] w-[172.5px]" data-name="Button/Filled">
      <div className="[word-break:break-word] flex flex-col font-['Proxima_Nova:Semibold',sans-serif] justify-center leading-[0] not-italic relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
        <p className="leading-[normal]">Call Customer</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[16px]" data-name="Phone Icon">
        <div className="absolute inset-[8.33%]" data-name="Vector">
          <div className="absolute inset-[-5.63%_-5.62%_-5.62%_-5.63%]">
